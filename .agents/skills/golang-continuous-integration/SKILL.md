...
user-invocable: true
license: MIT
compatibility: Designed for Codex or similar AI coding agents, and for projects using Golang.
metadata:
  author: samber
  version: "1.2.0"
  openclaw:
...
| **AI Review** | Codex / Copilot       | AI-powered PR review          |
...
`.github/workflows/ai-review.yml` — see [Codex-review.yml](./assets/Codex-review.yml)
...
Run `/install-github-app` in Codex to connect to the Codex API and configure the required secrets.
...
| No AI review in CI | Add Codex or Copilot review — catches logic, security, and architectural issues that static analysis misses |
